...
def generate_summary(data: LeagueData, week: int, model: str) -> str | None:
    ...
    response = OpenAI(api_key=api_key).responses.create(
        ...
        instructions=(
            ...
            "section listing at most five bench players with the largest scoring gaps over a starter at the same "
            "position and stating both scores; and a short closing line looking ahead without inventing predictions. Use exact team names, "
